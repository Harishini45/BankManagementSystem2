...
public class SignupThree extends JFrame implements ActionListener {
	...
	public SignupThree(String formno) {
        ...
        add(card);
		JLabel number = new JLabel("XXXX-XXXX-XXXX-1810");
		...
		servicesreq.setBounds(100,450,300,30);
		add(servicesreq);
		...
		submit.setBounds(150,670,100,30);
			...
			try {
				if(accountType.equals("")) {
					...
					try {
						...
						String query2 = "insert into login values('"+pinnumber+"','"+cardnumber+"','"+pinnumber+"')";
